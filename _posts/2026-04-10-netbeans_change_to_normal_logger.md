...
To reset to the old behaviour there is only a weird way within the editors hints. 
...
Here you can uncheck the System.Logger setting. Now a **normal** logger is generated again.
